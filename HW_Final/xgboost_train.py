...
def readPK():
    with open('train_report_df.pk', 'rb') as f:
        train = pickle.load(f)
    
    with open('test_report_df.pk', 'rb') as f:
        test = pickle.load(f)
    
    return train, test


def splitXYPart(train_df):
    pass
    #return train_df_x_part, train_df_y_part
...
if __name__ == "__main__":
    ...
    # Split train into x_part and y_part
